...
import { BookOpen, Video, Podcast, FileText, ExternalLink, ArrowRight, Link as LinkIcon } from 'lucide-react';
        ...
        <div className="container-sacred text-center">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto mb-10">
            <GlassCard solar className="p-6">
              ...
              <button className="px-4 py-2 rounded-full bg-emerald-glow/15 border border-emerald-glow/25 text-xs font-display tracking-widest text-emerald-glow hover:bg-emerald-glow/25 transition-all">
                Download
              </button>
            </GlassCard>
